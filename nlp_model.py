...
def create_entity_ruler(nlp):
    ...
    # Règles exemples à adapter/étendre selon besoins
    patterns = [
        # Numéro de carte : suite de lettres/chiffres (exemple simplifié)
        {"label": "NUMERO_CARTE", "pattern": [{"TEXT": {"REGEX": "^[A-Z0-9]{8,}$"}}]},
        # Sexe (féminin/masculin/m/f)
        ...
        # Dates naissance typiques (exemple)
        {"label": "DATE_NAISSANCE", "pattern": [{"LOWER": {"REGEX": "né|née"}}, {"LOWER": "le"}]},
        # Adresse (mot clé courant, simple)
